...
> **نکته:** این فایل نمونه جهت تست خروجی PDF با پشتیبانی از متن‌های ترکیبی فارسی و انگلیسی تهیه شده است.  
> **Note:** This sample file is designed to test mixed Persian and English content in PDF output.
